...
class MapView extends NativeBridgeComponent(React.PureComponent, NATIVE_MODULE_NAME) {
   ...
   * @return {FeatureCollection}
   */
  async querySourceFeatures(sourceId) {
    let filter = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : [];
    let sourceLayerIDs = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : [];
  ...
  _onCameraChanged(e) {
    var _this$props$onCameraC, _this$props;
    (_this$props$onCameraC = (_this$props = this.props).onCameraChanged) === null || _this$props$onCameraC === void 0 || _this$props$onCameraC.call(_this$props, e.nativeEvent.payload);
  }
  _onChange(e) {
    const {
