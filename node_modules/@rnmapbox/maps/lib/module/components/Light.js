...
function Light(props, ref) {
  ...
  useImperativeHandle(ref, () => ({
    setNativeProps(_props) {
      ...
      (_nativeLightRef$curre = nativeLightRef.current) === null || _nativeLightRef$curre === void 0 || _nativeLightRef$curre.setNativeProps(propsToPass);
    }
  }));
...
const RCTMGLLight = requireNativeComponent(NATIVE_MODULE_NAME);
