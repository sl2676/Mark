...
let UserTrackingMode = /*#__PURE__*/function (UserTrackingMode) {
  ...
  const _setCamera = config => {
    ...
    if (config.type === 'CameraStops') {
      for (const _stop of config.stops) {
        ...
        (_nativeCamera$current = nativeCamera.current) === null || _nativeCamera$current === void 0 || _nativeCamera$current.setNativeProps({
          stop: {
            stops: _nativeStops
          }
        });
      ...
      if (_nativeStop) {
        ...
        (_nativeCamera$current2 = nativeCamera.current) === null || _nativeCamera$current2 === void 0 || _nativeCamera$current2.setNativeProps({
          stop: _nativeStop
        });
      }
    }
