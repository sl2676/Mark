...
const BubbleTabBarItemComponent = ({
  ...
  const maxWidth = add(labelWidth, innerHorizontalSpace, minWidth); //#endregion
  //#region styles
  ...
  const containerStyle = [_styles.styles.container, {
    ...
    width: (0, _utilities.interpolate)(animatedFocus, {
      inputRange: [0, 1],
  ...
  const labelContainerStyle = [_styles.styles.labelContainer, {
    opacity: (0, _utilities.interpolate)(animatedFocus, {
      inputRange: [0.33, 1],
      outputRange: [0, 1]
    }),
    [isRTL ? 'left' : 'right']: (0, _utilities.interpolate)(animatedFocus, {
      inputRange: [0, 1],
