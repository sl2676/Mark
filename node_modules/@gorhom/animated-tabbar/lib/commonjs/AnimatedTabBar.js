...
function AnimatedTabBar(props) {
  ...
  const containerStyle = (0, _react.useMemo)(() => ({
    ...
    right: 0,
    transform: [{
      translateY: (0, _utilities.interpolate)(shouldShowTabBarAnimated, {
        inputRange: [0, 1],
  ...
  const handleIndexChange = (0, _hooks.useStableCallback)(index => {
    if (isReactNavigation5) {
  ...
  const handleLongPress = (0, _hooks.useStableCallback)(index => {
    if (isReactNavigation5) {
      const {
        key
      } = routes[index];
